...
typedef enum ur_function_t {
    ...
    UR_FUNCTION_PROGRAM_BUILD_EXP = 172,                                       ///< Enumerator for ::urProgramBuildExp
    UR_FUNCTION_PROGRAM_COMPILE_EXP = 173,                                     ///< Enumerator for ::urProgramCompileExp
    UR_FUNCTION_PROGRAM_LINK_EXP = 174,                                        ///< Enumerator for ::urProgramLinkExp
    /// @cond
