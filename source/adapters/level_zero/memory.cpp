...
ur_result_t enqueueMemCopyRectHelper(
  ...
  auto zeParams = ur2zeRectParams(SrcOrigin, DstOrigin, Region, SrcRowPitch,
                                  DstRowPitch, SrcSlicePitch, DstSlicePitch);

  ZE2UR_CALL(zeCommandListAppendMemoryCopyRegion,
             (ZeCommandList, DstBuffer, &zeParams.dstRegion, zeParams.dstPitch, zeParams.dstSlicePitch,
              SrcBuffer, &zeParams.srcRegion, zeParams.srcPitch, zeParams.srcSlicePitch, ZeEvent,
