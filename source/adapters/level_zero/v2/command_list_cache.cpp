...
command_list_cache_t::command_list_cache_t(ze_context_handle_t ZeContext)
    : ZeContext{ZeContext},
      immediateGetLatencyTracker("command_list_cache_t::immediateGet"),
      regularGetLatencyTracker("command_list_cache_t::regularGet") {}
...
command_list_cache_t::getImmediateCommandList(
  ...
  latency_tracker tracker(immediateGetLatencyTracker);
...
command_list_cache_t::getRegularCommandList(ze_device_handle_t ZeDevice,
  ...
  latency_tracker tracker(regularGetLatencyTracker);
