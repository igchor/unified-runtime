...
public:
  latency_printer()
      : logger(logger::create_logger("latency", true, false,
                                     logger::Level::INFO)) {}
  ...
  inline void print() {
    ...
    for (auto &[name, histogram] : values) {
      ...
      logger.log(logger::Level::INFO, "{},{},{},{},{},{},{},{},{},{},{},{},ns",
                 name, value.min, value.max, value.mean, value.stddev,
...
inline latency_printer &globalPrinter() {
...
public:
  inline latency_histogram(const char *name,
                           latency_printer &printer = globalPrinter(),
...
#define TRACKER_UNIQUE_NAME __COUNTER__
...
#define TRACK_SCOPE_LATENCY(name)                                              \
  static thread_local latency_histogram histogram(name);                       \
  latency_tracker tracker##TRACKER_UNIQUE_NAME(histogram);
