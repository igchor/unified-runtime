...
/// \param ptr[in][out] If memory provider is of type UMA_MEMORY_PROVIDER_TYPE_TRACKER, value of *ptr will be used for tracking purposes.
///        It will be updated with pointer to the allocated memory otherwise.
/// \return UMA_RESULT_SUCCESS on success or appropriate error code on failure
///
