...
static std::tuple<size_t, size_t, size_t> decodeVersion(std::string version) {
...
static bool isLevelZero(ur_platform_handle_t hPlatform) {
    size_t psize;
    EXPECT_EQ(
    ...
    return platform.find("Level-Zero") != std::string::npos;
}
