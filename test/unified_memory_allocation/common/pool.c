...
nullInitialize(struct uma_memory_provider_desc_t *providers,
...
uma_memory_pool_handle_t nullPoolCreate(void) {
    ...
    struct uma_memory_provider_desc_t providerDesc = {
        ...
        .providerType = UMA_MEMORY_PROVIDER_TYPE_DATA};
...
static enum uma_result_t
traceInitialize(struct uma_memory_provider_desc_t *providers,
                size_t numProviders, void *params, void **pool) {
